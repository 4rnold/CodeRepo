package com.tangyh.lamp.msg.config.mq;
...
public class TenantDatasourceConfiguration {
    ...
    public Binding dsQueueBinding() {
        return new Binding(BizMqQueue.TENANT_DS_QUEUE_BY_MSG, Binding.DestinationType.QUEUE, BizMqQueue.TENANT_DS_FANOUT_EXCHANGE_MSG, "", new HashMap(1));
    }

...
@MapperScan(basePackages = { "${packageBaseParent}", UTIL_PACKAGE }, annotationClass = Repository.class)
public class ${service}DynamicDataSourceAutoConfiguration extends BaseDynamicDataSourceAutoConfiguration {

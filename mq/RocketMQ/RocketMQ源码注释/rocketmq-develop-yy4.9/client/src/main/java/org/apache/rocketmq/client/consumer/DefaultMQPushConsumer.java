 ...
 * </p>
 */
//ok  推消费者  属性：消费者组、消息模式、从哪消费、消费时间戳、消息队列分配算法、主题订阅关系map、消息监听器、偏移量存储、最小最大消费线程、
    //调整线程池阈值、消费当前最大跨越offset、队列缓存1000消息、队列缓存100Mb、主题拉取阈值数，会根据来的主题数自动更新、主题拉取阈值大小MB
// 消息拉取间隔、消息消费批次最大大小、批次拉消息大小32、是否每次拉消息都更新订阅关系、最大重复消费次数，并发模式是16，有序模式是无穷、挂起队列超时1s
// shutdown时最大等待时间，0代表不等待
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * Default constructor.
     */
    //ok  构造，无参、命名空间、组名、rpc钩子、队列分配算法、是否追踪消息、追踪消息主题几个属性

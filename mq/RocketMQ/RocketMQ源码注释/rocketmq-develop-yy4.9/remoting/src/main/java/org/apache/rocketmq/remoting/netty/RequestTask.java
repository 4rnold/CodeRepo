...
public class RequestTask implements Runnable {
    private final Runnable runnable;   //具体需要执行的任务逻辑
    private final long createTimestamp = System.currentTimeMillis();  //创建任务的时间
    private final Channel channel;   //channel
    private final RemotingCommand request;   //请求命令
    private boolean stopRun = false;   //是否不运行

...
public class HttpsTester
{
    ...
    public void startClient() throws Exception
    {
        ...
        // route add 192.168.2.102 mask 255.255.255.255 192.168.0.1
        // 以上命令表示：目标为192.168.2.102报文，其发送的下一跳为192.168.0.1网关
        // 该路由项在使用完毕后，建议删除，其删除指令如下：
        // route delete 192.168.2.102 mask 255.255.255.255 192.168.0.1 删除
        // 如果没有删除，则所有本机报文都经过网卡绕一圈回来，会很耗性能
        // 不过该路由表项并没有保存，在电脑重启后失效
        // 提示：以上的本地IP和网关IP，需要结合自己的电脑网卡和网关去更改

        SecureHttpClient.sentRequest("https://192.168.2.102:18899/?param1=value1");
    }
}

...
public class StoreMybatisAutoConfiguration {
    ...
    @Bean(name = "dataSourceStoreSlave")
    @ConfigurationProperties("spring.datasource.store-slave")
    public DataSource dataSourceStoreSlave(){
        return DruidDataSourceBuilder.create().build();
    }
    ...
    private DataSource getMasterSlaveDataSource() throws SQLException {
        MasterSlaveRuleConfiguration masterSlaveRuleConfig = new MasterSlaveRuleConfiguration(
                "store_ds_master_slave", "dataSourceStore", Arrays.asList("dataSourceStoreSlave"));
    ...
    private Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("dataSourceStore", dataSourceStore());
        result.put("dataSourceStoreSlave", dataSourceStoreSlave());
        return result;
    }
}
